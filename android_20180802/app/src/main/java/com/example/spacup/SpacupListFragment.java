 ...
 * 정보 리스트를 보여주는 프래그먼트
 */
public class SpacupListFragment extends Fragment implements View.OnClickListener {
    ...
    /**
     * SpacupListFragment 인스턴스를 생성한다.
     * @return SpacupListFragment 인스턴스
     */
    public static SpacupListFragment newInstance() {
        SpacupListFragment f = new SpacupListFragment();
        return f;
    }

    /**
     * fragment_spacup_list.xml반으로 뷰를 생성한다.
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        View layout = inflater.inflate(R.layout.fragment_spacup_list, container, false);
    ...
    private void setRecyclerView() {
        ...
        infoListAdapter = new InfoListAdapter(context,
                R.layout.row_spacup_list, new ArrayList<FoodInfoItem>());
