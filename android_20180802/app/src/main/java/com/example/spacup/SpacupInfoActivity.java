...
import com.example.spacup.custom.WorkaroundMapFragment;
 ...
 * 정보를 보는 액티비티이다.
 */
public class SpacupInfoActivity extends AppCompatActivity
    ...
    /**
     * 정보를 보여주기 위해 사용자 시퀀스와 맛집 정보 시퀀스를 얻고
     * 이를 기반으로 서버에서 맛집 정보를 조회하는 메소드를 호출한다.
     */
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_spacup_info);
     ...
     * 서버에서 조회한 위도와 경도를 기반으로 지도를 표시한다.
     */
    @Override
