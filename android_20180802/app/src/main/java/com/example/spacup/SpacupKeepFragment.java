...
import com.example.spacup.adapter.KeepListAdapter;
...
import com.example.spacup.item.KeepItem;
 ...
 */
public class SpacupKeepFragment extends Fragment {
    ...
    /**
     * SpacupKeepFragment 인스턴스를 생성한다.
     * @return SpacupListFragment 인스턴스
     */
    public static SpacupKeepFragment newInstance() {
        SpacupKeepFragment f = new SpacupKeepFragment();
        return f;
    }

    /**
     * fragment_spacup_keep.xml반으로 뷰를 생성한다.
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        View layout = inflater.inflate(R.layout.fragment_spacup_keep, container, false);
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        keepListAdapter = new KeepListAdapter(context,
                R.layout.row_spacup_keep, keepList, memberSeq);
