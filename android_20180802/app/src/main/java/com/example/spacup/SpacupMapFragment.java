...
import com.example.spacup.adapter.MapListAdapter;
...
import com.example.spacup.item.GeoItem;
import com.example.spacup.lib.GeoLib;
 ...
 * 지도에서 위치를 보여주는 프래그먼트
 */
public class SpacupMapFragment extends Fragment
    ...
    /**
     * SpacupMapFragment 인스턴스를 생성해서 반환한다.
     * @return SpacupMapFragment 인스턴스
     */
    public static SpacupMapFragment newInstance() {
        SpacupMapFragment f = new SpacupMapFragment();
        return f;
    }

    /**
     * fragment_spacup_map.xml반으로 뷰를 생성한다.
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        View v = inflater.inflate(R.layout.fragment_spacup_map, container, false);
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        adapter = new MapListAdapter(context, R.layout.row_spacup_map, infoList);
    ...
    /**
     * 오른쪽 상단에 목록을 보여주는 버튼을 현재 상태 on 인자에 기반하여 설정한다.
    ...
    /**
     * 주어진 정보를 기반으로 정보를 조회하고 지도에 표시한다.
    ...
    /**
     * 리스트를 지도에 표시하는 메소드를 호출하고 지도에서 원을 그린다.
     * @param list 맛집 리스트
     */
    ...
    /**
     * 지도를 움직일 경우 정보를 조회해서 화면에 표시할 수 있도록 한다.
     */
    @Override
    ...
    /**
     * 지도를 일정 레벨 이상 확대했을 경우, 해당 위치에 있는 리스트를 서버에 요청한다.
     */
