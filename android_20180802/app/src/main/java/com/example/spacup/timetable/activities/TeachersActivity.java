...
public class TeachersActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_timetable_teachers);
        initAll();
    }
    ...
    private void setupAdapter() {
        ...
        adapter = new TeachersAdapter(TeachersActivity.this, listView, R.layout.timetable_listview_teachers_adapter, db.getTeacher());
    ...
    private void setupCustomDialog() {
        final View alertLayout = getLayoutInflater().inflate(R.layout.timetable_dialog_add_teacher, null);
