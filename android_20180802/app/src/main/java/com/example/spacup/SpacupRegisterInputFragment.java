 ...
 * 정보를 입력하는 액티비티
 */
public class SpacupRegisterInputFragment extends Fragment implements View.OnClickListener {
     ...
     * SpacupRegisterInputFragment 인스턴스를 생성해서 반환한다.
     * @param infoItem 정보를 저장하는 객체
     * @return SpacupRegisterInputFragment 인스턴스
     */
    public static SpacupRegisterInputFragment newInstance(FoodInfoItem infoItem) {
        Bundle bundle = new Bundle();
        bundle.putParcelable(INFO_ITEM, Parcels.wrap(infoItem));

        SpacupRegisterInputFragment fragment = new SpacupRegisterInputFragment();
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (getArguments() != null) {
            ...
            if (infoItem.seq != 0) {
                SpacupRegisterActivity.currentItem = infoItem;
            }
    ...
    /**
     * fragment_spacup_register_inputml 기반으로 뷰를 생성한다.
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        return inflater.inflate(R.layout.fragment_spacup_register_input, container, false);
    }
    ...
    public void onClick(View v) {
        ...
        if (v.getId() == R.id.prev) {
            GoLib.getInstance().goFragment(getFragmentManager(),
                    R.id.content_main, SpacupRegisterLocationFragment.newInstance(infoItem));
    ...
    /**
     *이미지를 등록할 수 있는 프래그먼트로 이동한다.
     */
    private void goNextPage() {
        GoLib.getInstance().goFragmentBack(getFragmentManager(),
                R.id.content_main, SpacupRegisterImageFragment.newInstance(infoItem.seq));
    }
}
