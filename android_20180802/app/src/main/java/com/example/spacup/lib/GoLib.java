...
import com.example.spacup.SpacupInfoActivity;
import com.example.spacup.SpacupRegisterActivity;
import com.example.spacup.ProfileActivity;
...
public class GoLib {
    ...
    public void goBestFoodRegisterActivity(Context context) {
        Intent intent = new Intent(context, SpacupRegisterActivity.class);
        intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
        context.startActivity(intent);
    }
    ...
    public void goBestFoodInfoActivity(Context context, int infoSeq) {
        Intent intent = new Intent(context, SpacupInfoActivity.class);
        intent.putExtra(SpacupInfoActivity.INFO_SEQ, infoSeq);
        context.startActivity(intent);
    }
}
